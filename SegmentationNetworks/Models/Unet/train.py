...
DROPOUT_P = 0.10  # Dropout probability (0.0 to not implement dropout)
...
# TRAIN_IMG_DIR = "/content/DFU_Proyect/SegmentationNetworks/data_DFU_images/data_MICCAI/train_images"  # Colab
